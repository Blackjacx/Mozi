...
Pod::Spec.new do |s|
  ...
  s.author             = { "hoshy" => "stefan@hoschkara.com" }
  # Or just: s.author    = "hoshy"
  # s.authors            = { "hoshy" => "stefan@hoschkara.com" }
  # s.social_media_url   = "http://twitter.com/hoshy"
  ...
  s.source       = { :git => "git@github.com:h0shy/Mozi.git", :tag => "#{s.version}" }
